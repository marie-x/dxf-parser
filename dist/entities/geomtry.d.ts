...
export declare type EntityName = 'POINT' | '3DFACE' | 'ARC' | 'ATTDEF' | 'BOUNDARYPATH' | 'CIRCLE' | 'DIMENSION' | 'ELLIPSE' | 'HATCH' | 'INSERT' | 'LINE' | 'LWPOLYLINE' | 'MTEXT' | 'POLYLINE' | 'SOLID' | 'SPLINE' | 'TEXT' | 'VERTEX';
